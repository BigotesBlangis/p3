...
map.getView().fit([-11093867.577556, 2154533.950478, -10967008.576883, 2223221.430093], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INMUEBLES FGJCDMX</h2>';
        return titleElement;
    })(),
